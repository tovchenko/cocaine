/** 11/05/2015
 *  Taras Tovchenko's modification of "kew" promises
 */
...
(function(defs) {
    ...
    Promise.prototype.reject = function (e) {
        ...
        if (this._ended) {
            this._handleError();
            nextTick(function onPromiseThrow() {
                throw e;
            });
        }
    ...
    defs.all = all;
    defs.bindPromise = bindPromise;
    defs.defer = defer;
    defs.delay = delay;
    defs.fcall = fcall;
    defs.isPromise = isPromise;
    defs.isPromiseLike = isPromiseLike;
    defs.nfcall = nfcall;
    defs.resolve = resolve;
    defs.reject = reject;
    defs.stats = stats;
    defs.allSettled = allSettled;
    defs.Promise = Promise;
    defs.getNextTickFunction = getNextTickFunction;
    defs.setNextTickFunction = setNextTickFunction;
